...
async function main(){
    ...
    await prisma.countries.upsert({where:{name:"Austrália"},update:{},create:{name:"Austrália",level:2}})
    await prisma.countries.upsert({where:{name:"Bélgica"},update:{},create:{name:"Bélgica",level:4}})
    await prisma.countries.upsert({where:{name:"Brasil"},update:{},create:{name:"Brasil",level:5}})
    await prisma.countries.upsert({where:{name:"Camarões"},update:{},create:{name:"Camarões",level:2}})
    await prisma.countries.upsert({where:{name:"Canadá"},update:{},create:{name:"Canadá",level:2}})
    await prisma.countries.upsert({where:{name:"Catar"},update:{},create:{name:"Catar",level:1}})
    await prisma.countries.upsert({where:{name:"Coreia do Sul"},update:{},create:{name:"Coreia do Sul",level:2}})
    await prisma.countries.upsert({where:{name:"Costa Rica"},update:{},create:{name:"Costa Rica",level:2}})
    await prisma.countries.upsert({where:{name:"Croácia"},update:{},create:{name:"Croácia",level:4}})
    await prisma.countries.upsert({where:{name:"Dinamarca"},update:{},create:{name:"Dinamarca",level:4}})
    await prisma.countries.upsert({where:{name:"Equador"},update:{},create:{name:"Equador",level:2}})
    await prisma.countries.upsert({where:{name:"Espanha"},update:{},create:{name:"Espanha",level:4}})
    await prisma.countries.upsert({where:{name:"Estados Unidos"},update:{},create:{name:"Estados Unidos",level:2}})
    await prisma.countries.upsert({where:{name:"França"},update:{},create:{name:"França",level:5}})
    await prisma.countries.upsert({where:{name:"Gana"},update:{},create:{name:"Gana",level:2}})
    await prisma.countries.upsert({where:{name:"Holanda"},update:{},create:{name:"Holanda",level:4}})
    await prisma.countries.upsert({where:{name:"Inglaterra"},update:{},create:{name:"Inglaterra",level:4}})
    await prisma.countries.upsert({where:{name:"Irã"},update:{},create:{name:"Irã",level:1}})
    await prisma.countries.upsert({where:{name:"Japão"},update:{},create:{name:"Japão",level:3}})
    await prisma.countries.upsert({where:{name:"Marrocos"},update:{},create:{name:"Marrocos",level:1}})
    await prisma.countries.upsert({where:{name:"México"},update:{},create:{name:"México",level:3}})
    await prisma.countries.upsert({where:{name:"País de Gales"},update:{},create:{name:"País de Gales",level:2}})
    await prisma.countries.upsert({where:{name:"Polônia"},update:{},create:{name:"Polônia",level:3}})
    await prisma.countries.upsert({where:{name:"Portugal"},update:{},create:{name:"Portugal",level:4}})
    await prisma.countries.upsert({where:{name:"Senegal"},update:{},create:{name:"Senegal",level:2}})
    await prisma.countries.upsert({where:{name:"Sérvia"},update:{},create:{name:"Sérvia",level:3}})
    await prisma.countries.upsert({where:{name:"Suíça"},update:{},create:{name:"Suíça",level:3}})
    await prisma.countries.upsert({where:{name:"Tunísia"},update:{},create:{name:"Tunísia",level:2}})
    await prisma.countries.upsert({where:{name:"Uruguai"},update:{},create:{name:"Uruguai",level:3}})

    await prisma.groups.upsert({where:{number:1},update:{},create:{name:"Grupo 1", number:1}})
    await prisma.groups.upsert({where:{number:2},update:{},create:{name:"Grupo 2", number:2}})
    await prisma.groups.upsert({where:{number:3},update:{},create:{name:"Grupo 3" , number:3} })
    await prisma.groups.upsert({where:{number:4},update:{},create:{name:"Grupo 4", number:4}})
    await prisma.groups.upsert({where:{number:5},update:{},create:{name:"Grupo 5", number:5}})
    await prisma.groups.upsert({where:{number:6},update:{},create:{name:"Grupo 6", number:6}})
